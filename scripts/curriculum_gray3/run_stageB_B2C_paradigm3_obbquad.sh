...
MANIFEST_DIR="manifests/curriculum_gray3_stageb_v1_B2C_paradigm3_obbquad"
TRAIN_MANIFEST="$MANIFEST_DIR/train_B2C_paradigm3_obbquad.csv"
VAL_MANIFEST="$MANIFEST_DIR/val_B2C_paradigm3_obbquad.csv"
SAVE_DIR="experiments/curriculum_gray3_stageB_B2C_paradigm3_obbquad"
...
echo "[DONE] B2-C_OBB training completed."
...
echo "[DONE] B2-C_OBB evaluation completed."
