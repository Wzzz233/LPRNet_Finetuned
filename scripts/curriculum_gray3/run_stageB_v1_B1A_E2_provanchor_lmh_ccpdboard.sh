...
SAVE_DIR="experiments/curriculum_gray3_stageB_v1_B1A_E2_provanchor_lmh_ccpdboard_eval_original"
LOG_PATH="$SAVE_DIR/train.log"
REPORT="reports/GREEN_STAGEB1A_E2_PROVANCHOR_LMH_CCPDBOARD_TRAINING_REPORT.md"
...
from pathlib import Path
root=Path('/home/wzzz/LPRNet')
exp=root/'experiments/curriculum_gray3_stageB_v1_B1A_E2_provanchor_lmh_ccpdboard_eval_original'
report=root/'reports/GREEN_STAGEB1A_E2_PROVANCHOR_LMH_CCPDBOARD_TRAINING_REPORT.md'
...
lines=[]
lines.append('# GREEN StageB1A-E2 Province-Anchor LMH ccpd_board Training Report')
lines.append('')
lines.append('日期：2026-04-26')
lines.append('')
lines.append('## 定义')
lines.append('复用 E1 accepted moderate LMH manifest/proxy；新增 province-anchor 训练信号并启用 soft-freeze：province=0.35, pos0=0.05, rear_seq=0.20, backbone_lr_mult=0.01。old proxy 保持历史 benchmark，new proxy 只作目标域辅助评测。')
lines.append('')
