...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_ablation/ABL3_second_only_015

rm -rf "$SAVE_DIR"
mkdir -p "$SAVE_DIR"

echo "[RUN] ABL-3: second-only = 0.15, rear=0, first=0"
$PY train_LPRNet.py \
  --cuda true \
  --data_mode manifest \
