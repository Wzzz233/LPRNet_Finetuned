...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e20a_cluster2_beijing_prefix_contrast_1200_e12c_stage2
...
echo "[RUN] E20A E12C->cluster2 province-contrast board-like append stage2"
echo "[INIT] $INIT"
