...
TRAIN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_e17c_cluster3_tail_600.csv
...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e17c_cluster3_tail_600_stage2
...
echo "[RUN] E17C E12->cluster3 tail append stage2"
echo "[INIT] $INIT"
