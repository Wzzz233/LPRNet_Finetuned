...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_h26/H26A_rear_full_seq

mkdir -p /home/wzzz/LPRNet/experiments/green_h26
rm -rf "$SAVE_DIR"
mkdir -p "$SAVE_DIR"

echo "[RUN] H26-A: rear full sequence (drop_chars=0)"
echo "[CONFIG] rear_seq_drop_chars=0 (supervise pos1-8, full overlap with CTC)"
