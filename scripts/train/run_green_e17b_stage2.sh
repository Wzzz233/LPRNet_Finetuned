...
TRAIN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_e17b_cluster3_transition_900.csv
...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e17b_cluster3_transition_900_stage2
...
echo "[RUN] E17B E12->cluster3 transition append stage2"
echo "[INIT] $INIT"
