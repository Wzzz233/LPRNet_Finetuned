...
DATA_DIR=/home/wzzz/LPRNet/tmp/green_edgefit_v4_e3_equalprov_b_20260412
V4_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_edgefit_v4_e3_equalprov_b_20260412_train.csv
TRAIN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_balance_round2_greenonly_b_anhui40_noleak_edgefit_tier3_v3_su_conservative_fixed_e3_equalprov_b_20260412.csv
SUMMARY_JSON=/home/wzzz/LPRNet/reports/GREEN_E3_EQUALPROV_B_MANIFEST_SUMMARY_20260412.json
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e3_equalprov_b_20260412
...
echo "[E3-B][GEN] generating equal-prov controlled dataset"
$PY src/utils/generate_green_edgefit_v4_boardlike_equalprov.py \
  --repo_root "$REPO_ROOT" \
  --out_dir "$DATA_DIR" \
  --dataset_name green_edgefit_v4_boardlike_e3_equalprov_b_20260412 \
  --source_name v4_boardlike_edgefit \
  --seed 20260413 \
  --preview_per_bucket 2 \
  --train_per_province_total 140 \
  --train_geometry_clean 21 \
  --train_board_mid_occ 56 \
  --train_board_low_occ 49 \
  --train_board_extreme_tail 14 \
...
echo "[E3-B][MANIFEST] building final train manifest"
...
if [[ ! -f "$SAVE_DIR/Final_LPRNet_model.pth" ]]; then
  echo "[E3-B][ERROR] Final model not found" >&2
  exit 1
fi

echo "[E3-B][EVAL] family aware"
...
$PY src/utils/update_training_status.py \
  ...
  --process-keyword green_e3_equalprov_b_20260412 \
...
echo "[DONE] green_e3_equalprov_b_20260412"
