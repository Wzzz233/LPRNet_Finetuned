...
GREEN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_balance_round2_greenonly_b_anhui40_noleak_edgefit_tier3_v2.csv
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_h34/H34F_edgefit_tier3_v2

mkdir -p /home/wzzz/LPRNet/experiments/green_h34
mkdir -p "$SAVE_DIR"

echo "[RUN] H34F: tier3 edgefit (simple/hard/extreme=7:2:1) with total province injections matched to H34C"
echo "[CONFIG] preserve H34C province totals and anhui ratio; only change difficulty layering + generator semantics"
