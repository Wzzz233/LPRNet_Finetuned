...
TRAIN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_e16a_nonanhui_ad_balance_12k_std_v1.csv
...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e16a_nonanhui_ad_balance_12k_std_v1_stage2
...
echo "[RUN] E16A E9C->non-Anhui AD-balance 12k std stage2"
echo "[INIT] $INIT"
