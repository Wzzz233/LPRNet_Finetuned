...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_h29/H29B_anhui40_noleak

mkdir -p /home/wzzz/LPRNet/experiments/green_h29
rm -rf "$SAVE_DIR"
mkdir -p "$SAVE_DIR"

echo "[RUN] H29-B: green8 train manifest with Anhui ratio ~40%, no synthetic val/test leakage"
echo "[CONFIG] Keep H25D rear setup; only change train manifest distribution using raw synthetic train split"
