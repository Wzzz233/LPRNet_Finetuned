...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_h27/H27A_stratified_proxy

mkdir -p /home/wzzz/LPRNet/experiments/green_h27
rm -rf "$SAVE_DIR"
mkdir -p "$SAVE_DIR"

echo "[RUN] H27-A: H25D single-variable test, only selection_proxy_mode=stratified"
echo "[CONFIG] same as H25D except selection_proxy_mode=stratified"
echo "[CONFIG] selection_strategy remains proxy_exact"
