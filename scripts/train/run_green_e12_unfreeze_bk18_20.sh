...
# 从 E12+PoseReplace best 起跑，放开 backbone 最后三层
INIT=/home/wzzz/LPRNet/experiments/green_e12_pose_replace_append_stage2/best_LPRNet_model.pth
...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e12_pose_replace_unfreeze_bk18_20
...
echo "[RUN] E12+PoseReplace best → unfreeze backbone.18/19/20, LR=1e-4"
echo "[INIT] $INIT"
...
echo "[DONE] Unfreeze bk18-20 experiment complete"
