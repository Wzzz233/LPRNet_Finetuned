...
TRAIN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_e17a_cluster2_suffixbank_900.csv
...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e17a_cluster2_suffixbank_900_stage2
...
echo "[RUN] E17A E12->cluster2 suffixbank append stage2"
echo "[INIT] $INIT"
