...
TRAIN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_e12_e9c_append_boarddump_anticollapse_5prov_1200.csv
...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e19a_cluster2_green8_adapter_pos0_e12c_stage2
...
echo "[RUN] E19A E12C->cluster2 green8 adapter+pos0 structure probe"
echo "[INIT] $INIT"
