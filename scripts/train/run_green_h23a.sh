...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_h23/H23A_rearseq030_first015
mkdir -p /home/wzzz/LPRNet/experiments/green_h23
rm -rf "$SAVE_DIR"
mkdir -p "$SAVE_DIR"

echo "[RUN] H23A rear-seq 0.30 + first-char 0.15"
$PY train_LPRNet.py \
  --cuda true \
  --data_mode manifest \
