#!/bin/bash
# v4 Training B: continuation from v3_best
DATE_TAG="20260508"
EXP_DIR="experiments/green_ccpd2019_cvr_v4_from_v3best_${DATE_TAG}"
mkdir -p "$EXP_DIR"
cd /home/wzzz/LPRNet
...
python3 -u src/training/train_LPRNet.py \
  ...
  --pretrained_model experiments/green_ccpd2019_tilt_db_challenge_cvreplace_v3_20260508/best_LPRNet_model.pth \
  --save_folder "$EXP_DIR" \
  ...
  --learning_rate 0.00001 --lr_schedule 4 6 8 \
  --lpr_max_len 8 \
