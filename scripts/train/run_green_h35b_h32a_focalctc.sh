...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_h35/H35B_h32a_focalctc

mkdir -p /home/wzzz/LPRNet/experiments/green_h35
rm -rf "$SAVE_DIR"
mkdir -p "$SAVE_DIR"

echo "[RUN] H35B = H32A + focal CTC + class-balanced first-char kept fixed"
