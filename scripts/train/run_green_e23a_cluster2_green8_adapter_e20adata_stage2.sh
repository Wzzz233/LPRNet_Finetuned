...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e23a_cluster2_green8_adapter_e20adata_stage2
...
echo "[RUN] E23A cluster2 green8-adapter on E20A contrast data"
echo "[INIT] $INIT"
