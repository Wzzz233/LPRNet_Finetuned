...
TRAIN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_e26_cluster3_tail_boost_900.csv
...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e26_cluster3_tail_boost_e18b_stage2
...
echo "[RUN] E26 E18B->cluster3 tail-boost append stage2"
echo "[INIT] $INIT"
