...
GREEN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_balance_round2_greenonly_b_anhui40_noleak_edgefit_tier3_v3_su_conservative.csv
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_h34/H34G_su_conservative_tier3

mkdir -p /home/wzzz/LPRNet/experiments/green_h34
mkdir -p "$SAVE_DIR"

echo "[RUN] H34G: reuse H34F data and only make Su province more conservative (192/36/12)"
echo "[CONFIG] all non-Su provinces identical to H34F; only Su train tier3 ratio changed"
