...
TRAIN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_e13a_e9c_append_slotalign_aa0_5prov_300.csv
...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e13a_e9c_append_slotalign_aa0_5prov_300_stage2
...
echo "[RUN] E13A E9C->slotalign AA0 append stage2"
echo "[INIT] $INIT"
