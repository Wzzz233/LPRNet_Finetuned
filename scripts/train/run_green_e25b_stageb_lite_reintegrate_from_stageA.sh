...
INIT=/home/wzzz/LPRNet/experiments/green_e25a_cluster2_repr_rebuild_twostage/stageA_preadapt/Final_LPRNet_model.pth
TRAIN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_e25b_stageB_lite_reintegrate.csv
TRAIN_SUMMARY=/home/wzzz/LPRNet/tmp/green_e25b_stageB_lite_summary.json
...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e25b_stageb_lite_reintegrate_from_stageA
...
for f in "$INIT" "$TRAIN_MANIFEST" "$TRAIN_SUMMARY" "$EVAL_MANIFEST" "$E7_MANIFEST" "$CLUSTER2_CSV" "$CLUSTER3_CSV" "$CLUSTER3_TAIL_CSV"; do
...
echo "[RUN] E25B stageB-lite reintegration from stageA"
$PY src/training/train_LPRNet.py \
  ...
  --lr_schedule 2 3 \
  --selection_proxy_eval_samples 1500 \
...
[[ -f "$SAVE_DIR/Final_LPRNet_model.pth" ]] || { echo "[ERR] final weight missing" >&2; exit 1; }

echo "[EVAL] family-aware"
