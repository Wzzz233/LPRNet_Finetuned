...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_multihead_round3/E_green_head_capacity_expE

rm -rf "$SAVE_DIR"
mkdir -p "$SAVE_DIR"

echo "[RUN] E_green_head_capacity_expE with 3-layer 512ch green8 head, batch=128"
$PY train_LPRNet.py \
  --cuda true \
  --data_mode manifest \
...
echo "[DONE] Experiment E complete. Results saved to $SAVE_DIR"
