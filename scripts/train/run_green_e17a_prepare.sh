...
BANK_JSON=$BANK_DIR/suffix_bank_cluster2.json
OUT_DIR=/home/wzzz/LPRNet/generated/green_e17a_cluster2_suffixbank_900
OUT_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_e17a_cluster2_suffixbank_900.csv
...
$PY src/utils/generate_green_e17a_cluster2_suffixbank.py \
  ...
  --dataset-name green_e17a_cluster2_suffixbank_900 \
  --source-name e17a_cluster2_suffixbank_900

echo "[DONE] E17A prepare complete"
