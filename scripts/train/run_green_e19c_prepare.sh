...
OUT_DIR=/home/wzzz/LPRNet/generated/green_e19c_su_bf_low_tail_dense_240
OUT_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_e19c_su_bf_low_tail_dense_240.csv
...
$PY src/utils/generate_green_e18b_su_bf_transition_dense.py \
  ...
  --dataset-name green_e19c_su_bf_low_tail_dense_240 \
  --source-name e19c_su_bf_low_tail_dense_240 \
  --target-texts 苏BF01111 \
  --bucket-plan board_low_occ=120,board_extreme_tail=120 \
  --dump-csv "$CLUSTER3_CSV" \
  --dump-csv "$CLUSTER3_TAIL_CSV"

echo "[DONE] E19C prepare complete"
