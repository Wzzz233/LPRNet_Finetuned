...
GREEN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_balance_round2_greenonly_b_anhui40_noleak_edgefit_allprov_v4_realistic_b.csv
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_h34/H34D_edgefit_allprov_v4_realistic_b

mkdir -p /home/wzzz/LPRNet/experiments/green_h34
mkdir -p "$SAVE_DIR"

echo "[RUN] H34D: realistic edgefit harder warp aligned to CCPD real black-border distribution"
echo "[CONFIG] based on H34C, replacing edgefit dataset v3 -> v4_realistic_b"
