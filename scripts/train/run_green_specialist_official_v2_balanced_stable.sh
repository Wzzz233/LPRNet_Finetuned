...
TRAIN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_specialist_official_v2_balanced_stable.csv
EVAL_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_balance_aggr_v1.csv
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_specialist_official_v2_balanced_stable

mkdir -p /home/wzzz/LPRNet/experiments
rm -rf "$SAVE_DIR"
mkdir -p "$SAVE_DIR"

echo "[RUN] green_specialist_official_v2_balanced_stable"
echo "[INIT] $INIT"
