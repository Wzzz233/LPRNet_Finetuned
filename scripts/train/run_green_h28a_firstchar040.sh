...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_h28/H28A_firstchar040

mkdir -p /home/wzzz/LPRNet/experiments/green_h28
rm -rf "$SAVE_DIR"
mkdir -p "$SAVE_DIR"

echo "[RUN] H28-A: H25D single-variable test, only first_char_aux_weight=0.40"
echo "[CONFIG] keep rear_seq_aux_weight=0.30 and rear_seq_drop_chars=1"
echo "[CONFIG] first_char_aux_weight: 0.15 -> 0.40"
