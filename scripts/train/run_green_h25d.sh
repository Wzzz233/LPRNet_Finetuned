...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_h25/H25D_rear_from_pos2

mkdir -p /home/wzzz/LPRNet/experiments/green_h25
rm -rf "$SAVE_DIR"
mkdir -p "$SAVE_DIR"

echo "[RUN] H25-D: rear from pos2 (drop_chars=1), rear=0.30, first=0.15"
echo "[CONFIG] rear_seq_drop_chars=1 (supervise pos2-8)"
echo "[CONFIG] rear_seq_aux_weight=0.30"
echo "[CONFIG] first_char_aux_weight=0.15"
