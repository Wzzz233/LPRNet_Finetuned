...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_h27/H27B_balanced_recovery

mkdir -p /home/wzzz/LPRNet/experiments/green_h27
rm -rf "$SAVE_DIR"
mkdir -p "$SAVE_DIR"

echo "[RUN] H27-B: H27A single-variable test, only selection_strategy=balanced_recovery"
echo "[CONFIG] same as H27A except selection_strategy=balanced_recovery"
echo "[CONFIG] selection_proxy_mode remains stratified"
...
echo "[DONE] H27-B complete"
echo "[RESULT] Check $SAVE_DIR/eval_family_aware.json for metrics"
