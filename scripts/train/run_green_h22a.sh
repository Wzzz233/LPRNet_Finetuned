...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_h22/H22A_rearseq_w040
mkdir -p /home/wzzz/LPRNet/experiments/green_h22
rm -rf "$SAVE_DIR"
mkdir -p "$SAVE_DIR"

echo "[RUN] H22A rear-sequence weight 0.40"
$PY train_LPRNet.py \
  --cuda true \
  --data_mode manifest \
