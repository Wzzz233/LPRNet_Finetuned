...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e18a_cluster2_firstchar_cb_rescue_e12c_stage2
...
echo "[RUN] E18A E12C->cluster2 first-char class-balanced rescue"
echo "[INIT] $INIT"
