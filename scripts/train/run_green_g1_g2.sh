...
ROOT_EXP=/home/wzzz/LPRNet/experiments/green_post_f1f2
mkdir -p "$ROOT_EXP"
...
echo "=========================================="
echo "Starting G1: D + 15 epoch + batch64"
echo "=========================================="
run_one G1_D_15epoch_batch64 15 64 0.0003 "3 5" 2000

echo "=========================================="
echo "Starting G2: D + longer high-lr schedule"
echo "=========================================="
run_one G2_D_lr_schedule_7_10 10 64 0.0003 "7 10" 2000

echo "[DONE] G1 and G2 experiments complete"
