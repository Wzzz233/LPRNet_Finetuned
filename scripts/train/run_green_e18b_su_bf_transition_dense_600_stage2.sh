...
TRAIN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_e18b_su_bf_transition_dense_600.csv
...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e18b_su_bf_transition_dense_600_stage2
...
echo "[RUN] E18B E12C->dense SuBF transition append stage2"
echo "[INIT] $INIT"
