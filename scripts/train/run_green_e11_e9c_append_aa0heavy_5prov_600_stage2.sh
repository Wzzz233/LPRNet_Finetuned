...
TRAIN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_e11_e9c_append_aa0heavy_5prov_600.csv
...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e11_e9c_append_aa0heavy_5prov_600_stage2
...
echo "[RUN] E11 E9C->AA-heavy boarddump append stage2"
echo "[INIT] $INIT"
