...
TRAIN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_e9c_exact_template_allprov_1800.csv
EVAL_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_balance_aggr_v1_existing_only.csv
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e9c_exact_template_allprov_1800

mkdir -p /home/wzzz/LPRNet/experiments
rm -rf "$SAVE_DIR"
mkdir -p "$SAVE_DIR"

echo "[RUN] E9C allprov exact-template same-budget"
