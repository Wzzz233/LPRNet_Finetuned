...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_h32/H32A_classbalanced_firstchar

mkdir -p /home/wzzz/LPRNet/experiments/green_h32
rm -rf "$SAVE_DIR"
mkdir -p "$SAVE_DIR"

# Preflight: parameter sanity
case "proxy_exact" in
...
echo "[RUN] H32-A: H29B baseline + class-balanced CE for first-char auxiliary head"
echo "[CONFIG] Only change first_char_loss_type from ce to class_balanced_ce, beta=0.999"
echo "[BASE] Using H29B no-leak manifest with 40% Anhui ratio"
