...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_h35/H35C_h32b_firstaux012

mkdir -p /home/wzzz/LPRNet/experiments/green_h35
rm -rf "$SAVE_DIR"
mkdir -p "$SAVE_DIR"

echo "[RUN] H35C = H32B + first_char_aux_weight 0.12"
