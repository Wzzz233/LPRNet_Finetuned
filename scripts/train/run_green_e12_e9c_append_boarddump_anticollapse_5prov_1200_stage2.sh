...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e12_e9c_append_boarddump_anticollapse_5prov_1200_stage2
...
echo "[RUN] E12 E9C->anti-collapse boarddump append stage2"
echo "[INIT] $INIT"
