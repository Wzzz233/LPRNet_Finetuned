...
TRAIN_MANIFEST=$(python3 - <<'PY'
import glob
paths = sorted(glob.glob('/home/wzzz/LPRNet/manifests/unified_manifest_green_e14a_image_local_probe_300_v1_fullrun_*.csv'))
...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e14a_e9c_append_image_local_probe_300_v1
...
echo "[RUN] E14A E9C->image-local exact recovery probe"
echo "[INIT] $INIT"
