...
GREEN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_balance_round2_greenonly_b_anhui40_noleak_edgefit_allprov_v2_zhe_guard.csv
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_h34/H34B_edgefit_allprov_v2_zhe_guard

mkdir -p /home/wzzz/LPRNet/experiments/green_h34
rm -rf "$SAVE_DIR"
mkdir -p "$SAVE_DIR"

echo "[RUN] H34B: keep H34A mainline, only lower harder ratio for 浙 train to 180/60"
echo "[CONFIG] same as H34A except edgefit dataset = v2_zhe_guard"
echo "[CONFIG] zhe train quota simple=180 harder=60; others unchanged; anhui remains 40/40"
