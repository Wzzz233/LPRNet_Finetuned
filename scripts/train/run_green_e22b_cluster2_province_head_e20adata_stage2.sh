...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e22b_cluster2_province_head_e20adata_stage2
...
echo "[RUN] E22B cluster2 province-head + E20A contrast data stage2"
echo "[INIT] $INIT"
