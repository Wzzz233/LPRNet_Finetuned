...
TRAIN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_e9b_exact_template_allprov_11160.csv
EVAL_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_balance_aggr_v1_existing_only.csv
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e9b_exact_template_allprov_11160

mkdir -p /home/wzzz/LPRNet/experiments
rm -rf "$SAVE_DIR"
mkdir -p "$SAVE_DIR"

echo "[RUN] E9B allprov exact-template scaled"
