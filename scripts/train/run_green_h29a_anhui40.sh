...
TRAIN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_balance_round2_greenonly_b_anhui40_exact.csv
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_h29/H29A_anhui40_exact

mkdir -p /home/wzzz/LPRNet/experiments/green_h29
rm -rf "$SAVE_DIR"
mkdir -p "$SAVE_DIR"

echo "[RUN] H29-A: green8 train manifest with Anhui ratio ~40%"
echo "[CONFIG] Keep H25D rear setup; only change train manifest distribution"
