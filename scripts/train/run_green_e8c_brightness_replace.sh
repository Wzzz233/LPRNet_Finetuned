...
# E8C: brightness augmentation + board-native data replacement for 5 provinces
INIT=/home/wzzz/LPRNet/experiments/green_specialist_official_v3_tier3_mix/Final_LPRNet_model.pth
TRAIN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_e8c_brightness_replace_5prov.csv
EVAL_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_balance_aggr_v1_existing_only.csv
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e8c_brightness_replace
...
echo "[RUN] E8C: brightness augmentation + board-native replacement for 苏/沪/浙/粤/陕"
echo "[INIT] $INIT"
