...
TRAIN_MANIFEST=/home/wzzz/LPRNet/manifests/unified_manifest_green_balance_round2_greenonly_b_anhui40_noleak_edgefit_tier3_v3_su_conservative_fixed_e6c_boardnative_append_v2_a800_20260413.csv
...
SAVE_DIR=/home/wzzz/LPRNet/experiments/green_e6c_b_boardnative_append_v2_a800_20260413
...
echo "[RUN] green_e6c_b_boardnative_append_v2_a800_20260413"
echo "[INIT] $INIT"
...
$PY src/training/train_LPRNet.py \
  ...
  --main_group_ratios ccpd_board=0.85,board_dump=0.15 \
  --main_group_clip 8.0 \
...
echo "[DONE] green_e6c_b_boardnative_append_v2_a800_20260413"
