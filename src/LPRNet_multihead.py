...
def infer_checkpoint_multihead_config(state_dict, default_pos0_head_cols=4):
...
def build_lprnet_multihead_from_state_dict(state_dict, lpr_max_len=8, phase=False, class_num=66, dropout_rate=0.5,
    ...
    cfg = infer_checkpoint_multihead_config(state_dict, default_pos0_head_cols=default_pos0_head_cols)
